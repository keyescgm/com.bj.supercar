alert("main js entered");
//main.js
angular
.module('app',['angular-timeline'])
...
.controller('currentJobTimeLine', currentJobTimeLine)
.controller('newJobCtr', newJobCtr);
...
currentJobTimeLine.$inject = ['$scope'];
function currentJobTimeLine($scope) {
...
newJobCtr.$interval = ['$scope', '$http'];
function newJobCtr($scope, $http) {

  $scope.jobName = "123";

  $scope.saveJob = function() {
    console.log("do job save action")
  }
}
